...
- (1) testing two MPI approach for matrix transposition with different number of processes
    - Using MPI_Bcast()
...
```bash
$ mpich -std=c11 main.c checksym_functions.c transp_functions.c utils.c -lm -fopenmp -o matrix_transposition.o
